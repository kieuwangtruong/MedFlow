...
class Event(BaseModel):
    ...
    def timezone_required(self):
        ...
        if self.event_type==EventType.OVERRIDE_RECORDED and not self.reason_code: raise ValueError("reason_code is required for OVERRIDE_RECORDED")
        return self

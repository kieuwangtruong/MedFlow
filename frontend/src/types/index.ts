...
export interface PatientPathway { visitId: string; visitStatus: VisitStatus; queueNumber: string; currentRoom: string; currentTaskType?: 'INITIAL_CONSULT' | 'DIAGNOSTIC_SERVICE' | 'RETURN_REVIEW'; waitingForValidatedResult?: boolean; resultValidated?: boolean; peopleAhead: number; estimatedWait: number; steps: PathwayStep[] }
